...
import com.example.testmusicapp1.databinding.FragmentProfileBinding
import com.example.testmusicapp1.helper.Helper
import com.example.testmusicapp1.helper.Helper.showDeleteAccountDialog
import com.example.testmusicapp1.helper.Helper.showLogOutDialog
...
import com.example.testmusicapp1.utils.Utils.APP_VERSION
...
class Profile : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.profileData.observe(viewLifecycleOwner){ response->
            when(response){
                ...
                is Resources.Success -> fetchProfileData(response)
            }
        }
    ...
    private fun fetchProfileData(response: Resources.Success<UserDataModel>) {
